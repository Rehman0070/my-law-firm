        ...
        window.executeNavSearch = function(event, value) {
            if (event.key === 'Enter') {
        ...
        const localKnowledgeBase = [
            ...
            },
            {
                ...
                keywords: ["consultation", "meet", "appointment", "book", "bring", "meeting", "free legal consultation"],
            ...
            {
                category: "how_to_get_bail",
                keywords: ["how to get bail in kolkata", "where can i get bail lawyer near me"],
                response: "To secure bail in Kolkata, you should immediately contact an experienced criminal lawyer to review your case and file for Anticipatory or Regular Bail at the Session Court or High Court. Contact us at 074393 15183 for emergency legal help."
            },
            {
                category: "best_lawyer_queries",
                keywords: ["who is the best criminal lawyer in howrah", "which lawyer is best for divorce in kolkata"],
                response: "Advocate A. Rehman Khan is highly regarded as one of the best criminal and divorce lawyers in the region, bringing 25+ years of litigation experience to the Calcutta High Court and District Courts."
            },
            {
                category: "qna_fraud",
        ...
        window.handleEnterKeyPress = function(event) {
        ...
        if (testimonialTrack) {
            ...
            testimonialTrack.addEventListener('touchstart', () => { isAutoScrolling = false; }, {passive: true});
            testimonialTrack.addEventListener('touchend', () => { isAutoScrolling = true; }, {passive: true});
